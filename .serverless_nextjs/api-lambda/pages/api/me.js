...
/******/ 	return __webpack_require__(__webpack_require__.s = "kNK+");
/******/ })
/************************************************************************/
/******/ ({
...
async function me(req, res) {
  try {
    await _utils_auth0__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].handleProfile(req, res, {});
  } catch (error) {
    console.error(error);
    ...
    function handleRewrites(parsedUrl) {
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("Brxj")
          await apiResolver(
            req,
            res,
