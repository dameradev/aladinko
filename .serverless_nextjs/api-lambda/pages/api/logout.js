...
/******/ 	return __webpack_require__(__webpack_require__.s = "9WaY");
/******/ })
/************************************************************************/
/******/ ({
    ...
    function handleRewrites(parsedUrl) {
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("uKdW")
          await apiResolver(
            req,
            res,
...
async function logout(req, res) {
  try {
    await _utils_auth0__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].handleLogout(req, res);
  } catch (error) {
    console.error(error);
