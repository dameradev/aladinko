...
/******/ 	return __webpack_require__(__webpack_require__.s = "HJBu");
/******/ })
/************************************************************************/
/******/ ({
    ...
    function handleRewrites(parsedUrl) {
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("rPcO")
          await apiResolver(
            req,
            res,
...
async function login(req, res) {
  try {
    await _utils_auth0__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].handleLogin(req, res, {});
  } catch (error) {
    console.error(error);
